...
const InitContract = ({
    ...
    const handleInit = async () => {
        ...
        onTransaction(promise, "Carbon Credits contract initialized successfully!");
    };
        ...
        <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                    Initialize the Carbon Credits contract on-chain. This sets up the storage for projects and credits.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Button
